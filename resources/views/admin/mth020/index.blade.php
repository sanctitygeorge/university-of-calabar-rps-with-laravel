...
<div class="container">
	...
	<div class="col-md-2">
		<h3 align="right">
		<a href="{{ route('mth020.create')}}" class="btn btn-sm btn-primary"> Add New Result</a>
		<br><a href="{{ route('mth020.truncate')}}" class="btn btn-sm btn-danger">Delete All Results</a>
		</h3>
	</div>  
	...
	<br>
		...
		<div class="col-md-12">
	<hr>
			<h2 align="center">Pre-Degree Mathematics 2 (MTH 020)  Results Sheet</h2>
