...
<div class="container">
    ...
    <li class="active">
    <i class="fa fa-chevron-right" style="padding:2px; font-size:10px; width:20px;"></i>CHM010</li>
    </ol>
</div>
...
<br>
{!! Form::model($chm010, array('route' => array('chm010.update', $chm010->id), 'method' => 'PUT')) !!}
    ...
    <div class="col-sm-6">
        ...
        <h4>Last Created:</h4> <p class="lead"> {{ date('M j, Y h:ia', strtotime($chm010->created_at)) }}</p>
         
        </div>
        
        <div class="col-sm-6">
       <h4> Last Updated:</h4> <p class="lead"> {{ date('M j, Y h:ia', strtotime($chm010->updated_at)) }}</p>
        </div>   
    </div> 
    <br>
    ...
    <div class="col-sm-3">
        ...
        {!! Html::linkRoute('chm010.index', 'Cancel', array($chm010->id), array('class'=>'btn btn-danger btn-block')) !!}
