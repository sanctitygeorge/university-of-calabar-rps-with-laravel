...
<div class="container">
    ...
    <div class="container">
{!! Form::model($phy020, array('route' => array('phy020.update', $phy020->id), 'method' => 'PUT')) !!}
    ...
    <div class="col-sm-6">
        ...
        <h4>Last Created:</h4> <p class="lead"> {{ date('M j, Y h:ia', strtotime($phy020->created_at)) }}</p>
         
        </div>
        
        <div class="col-sm-6">
       <h4> Last Updated:</h4> <p class="lead"> {{ date('M j, Y h:ia', strtotime($phy020->updated_at)) }}</p>
        </div>   
    </div> 
    <br>
    ...
    <div class="col-sm-3">
        ...
        {!! Html::linkRoute('phy020.index', 'Cancel', array($phy020->id), array('class'=>'btn btn-danger btn-block')) !!}
