...
<div class="container">
    ...
    <button type="submit" style="padding-right:10px;"><i class="fa fa-search" style="width:30px;"></i></button>
     ...
     <div class="col-md-2">
		<h3 align="right">
		<a href="{{ route('bio020.create')}}" class="btn btn-sm btn-primary"> Add New Result</a>
		<br><a href="{{ route('bio020.truncate')}}" class="btn btn-sm btn-danger">Delete All Results</a>
		</h3>
	</div>
	...
	<br>
		...
		<div class="col-md-12">
	<hr>
			<h2 align="center">Foundation Biology 2  (BIO 020)  Results Sheet</h2>
