...
<div class="container">
    ...
    <button type="submit" style="padding-right:10px;"><i class="fa fa-search" style="width:30px;"></i></button>
     ...
     <div class="col-md-2">
		<h3 align="right">
		<a href="{{ route('bio010.index')}}" class="btn btn-sm btn-primary"> Back</a>
		</h3>
	</div>
	...
	<br>
		...
		<div class="col-md-6">
		<br>
			<h2>Search Results (BIO 010)</h2>

		</div>
		<div class="col-md-6">
		<br>
			<!-- <h1>Search Results</h1> -->
        <strong><h3>{{ $bio010->total() }} result(s) for '{{ request()->input('query') }}'</h3></strong>
