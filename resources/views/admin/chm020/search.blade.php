{{ route('import') }}@extends('layouts.app')
@section('content')
...
<div class="container">
	...
	<div class="col-md-2">
		<h3 align="right">
		<a href="{{ route('chm020.index')}}" class="btn btn-sm btn-primary"> Back</a>
		</h3>
	</div>  
	...
	<br>
		...
		<div class="col-md-6">
		<br>
			<h2>Search Results (CHM 020)</h2>

		</div>
		<div class="col-md-6">
		<br>
			<!-- <h1>Search Results</h1> -->
        <strong><h3>{{ $chm020->total() }} result(s) for '{{ request()->input('query') }}'</h3></strong>
				...
				<tbody>
					@foreach($chm020 as $chm2)
						<tr>
							...
							<td><a href="{{ route('chm020.show', $chm2->id)}}" class=" btn btn-default btn-sm"> View </a>  <a href="{{ route('chm020.edit', $chm2->id)}}" class="btn btn-success btn-sm" ><i class="fa fa-edit"></i></a></td>
						</tr>
					@endforeach
