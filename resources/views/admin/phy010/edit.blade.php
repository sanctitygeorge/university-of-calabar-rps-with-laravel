...
<div class="container">
    ...
    <li class="active">
    <i class="fa fa-chevron-right" style="padding:2px; font-size:10px; width:20px;"></i>Update Result</li>
    </ol>
</div>
...
<br>
{!! Form::model($phy010, array('route' => array('phy010.update', $phy010->id), 'method' => 'PUT')) !!}
    ...
    <div class="col-sm-6">
        ...
        <h4>Last Created:</h4> <p class="lead"> {{ date('M j, Y h:ia', strtotime($phy010->created_at)) }}</p>
         
        </div>
        
        <div class="col-sm-6">
       <h4> Last Updated:</h4> <p class="lead"> {{ date('M j, Y h:ia', strtotime($phy010->updated_at)) }}</p>
        </div>   
    </div> 
    <br>
    ...
    <div class="col-sm-3">
        ...
        {!! Html::linkRoute('phy010.index', 'Cancel', array($phy010->id), array('class'=>'btn btn-danger btn-block')) !!}
