...
<div class="container">
    ...
    <li class="active">
    <i class="fa fa-chevron-right" style="padding:2px; font-size:10px; width:20px;"></i>ENG020</li>
    </ol>
</div>
...
<br>
{!! Form::model($eng020, array('route' => array('eng020.update', $eng020->id), 'method' => 'PUT')) !!}
    ...
    <div class="col-sm-6">
        ...
        <h4>Last Created:</h4> <p class="lead"> {{ date('M j, Y h:ia', strtotime($eng020->created_at)) }}</p>
         
        </div>
        
        <div class="col-sm-6">
       <h4> Last Updated:</h4> <p class="lead"> {{ date('M j, Y h:ia', strtotime($eng020->updated_at)) }}</p>
        </div>   
    </div> 
    <br>
    ...
    <div class="col-sm-3">
        ...
        {!! Html::linkRoute('eng020.index', 'Cancel', array($eng020->id), array('class'=>'btn btn-danger btn-block')) !!}
